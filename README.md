...
There are 5 folders for the project design and structure.
The presentation folder contains the PPTX presentation that was presented in class.
The security settings folder shows the main security settings that were set for the website.
